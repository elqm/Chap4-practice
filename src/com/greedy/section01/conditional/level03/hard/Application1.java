...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		if(op == '+') {
			...
			System.out.println(num1 + " " + op + " " + num2 + " = " + result2);
			
		} else if(op == '*') {
			
			int result3 = num1 * num2;
			System.out.println(num1 + " " + op + " " + num2 + " = " + result3);
			
		} else if(op == '/') {
			
			int result4 = num1 / num2;
			System.out.println(num1 + " " + op + " " + num2 + " = " + result4);
			
		} else if(op == '%') {
			
			int result5 = num1 % num2;
			System.out.println(num1 + " " + op + " " + num2 + " = " + result5);
